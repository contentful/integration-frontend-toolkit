...
`@contentful/integration-frontend-toolkit`. An ADR documents a significant technical decision: the
context that made it necessary, the options considered, the choice made, and the consequences.
...
commit SHAs, pull request numbers, code, and configuration.

| Date | Status | Title |
|---|---|---|
| [2023-12-20](./2023-12-20-emit-build-output-to-package-root.md) | Accepted | Emit Build Output to the Package Root Instead of Using an Exports Map |
